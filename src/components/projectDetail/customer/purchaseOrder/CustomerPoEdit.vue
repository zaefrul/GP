        ...
        <div class="container" style="margin-bottom: 60px;margin-top: 30px;">
            <div class="card">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in customerPoEdit" :key="index++">
                        <td>{{ index }}</td>
                ...
                <router-link :to="'/project-detail/' + this.$route.params.pid + '/cpo'" class="btn btn-primary ml-3" style="float: right;" tag="button">Save</router-link>
