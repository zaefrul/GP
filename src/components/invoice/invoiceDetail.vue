              ...
              <header>
                <div class="row">
                  ...
                  <div class="col company-details">
                    <h2 class="name">
                      <a target="_blank" href="https://lobianijs.com">GRIZPOWER SDN. BHD.</a>
                    </h2>
                    <div>No 18 & 18 1, Jln Seri Rejang 3,</div>
                    <div>Taman Sri Rampai,</div>
                    <div>Kuala Lumpur, Wilayah Persekutuan Kuala Lumpur</div>
                    <div>+603-4144 3365</div>
                  </div>
                </div>
              </header>
              <main>
